...
- Developed _Freak-Cha_ ([freakcha.com](https://freakcha.com)), a CAPTCHA-inspired challenge using facial expression recognition; awarded _Funniest Hack_ at HackHarvard 2025.
...
- Led full-stack development of a controlled AI-access platform for CTF competitions, enabling 80 participants to query LLMs under organiser-enforced rate limits and usage policies.
- Built guardrails, LLM middleware, and a RAG system to ground responses in cybersecurity knowledge while reducing the risk of AI-assisted cheating.
- Introduced a token budget that forced participants to prompt carefully and preserve skill expression during the event.
...
- Founded _RV Media_, a student-run initiative focused on digital storytelling and event archiving.
