...
date: "2024-11-11"
author: "Anselm Long"
image: "/blogs/vbook/images/vbook.png"
tags:
  - java
  - javafx
  - cs2103t
...
In my second year at NUS, I took **CS2103T: Software Engineering** â€” a core module that pretty much every computing student both dreads and looks forward to.

The premise was simple (at least at first): Take an existing address book app and morph it into something new and useful. The catch? We had to do it in a real team, using real software engineering practices â€” version control, code reviews, documentation, issue tracking, testing... basically everything you'd expect in an actual development environment.
...
We used **GitHub Projects** to track issues and milestones, and everyone had to submit **pull requests** that were reviewed before merging â€” so it really felt like working in a small company. This was my first experience with merge conflicts. Horrible.
...
But beyond the code, there was a lot of invisible work â€” keeping the team aligned, managing deadlines, and figuring out what "done" really meant.
...
Learning to discuss and document everything â€” from command formats to UI color schemes â€” was what kept the project moving.
...
This module taught me the foundations of **team-based software engineering** â€” version control, testing, documentation, and communication. These are the same skills I've carried into every project since, from hackathons to my portfolio site.
