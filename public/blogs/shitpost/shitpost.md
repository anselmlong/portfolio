...
"excited to share that i just got promoted to senior L1 cookie! ðŸª"

"after 12 years, i'm finally ready to share my journey..."

"to the developer who pushed to main on a friday â€” i see you, and i forgive you."

at some point i stopped asking "who writes this stuff?" and started wondering... what if i could make a machine do it for me?

## what i built

**[shitpost.anselmlong.com](https://shitpost.anselmlong.com)** â€” a satirical linkedin post generator powered by AI.

you enter a topic (like "sprint planning" or "coworker who doesn't refactor") and get back 6 different comedic personas:

1. **tech-bro** â€” the classic "journey" post, all about learnings and growth
2. **tryhard** â€” motivational LinkedIn that treats "replied to email within 24h" as a watershed career moment
3. **unhinged** â€” lowercased rage hooks that start alarming, become sincere, end subtly flexing
4. **singaporean** â€” like texting friends on WhatsApp, casually unbothered
5. **lowercase** â€” Gen Z performing authenticity as a brand strategy
6. **anselm** â€” a computing student who posts on LinkedIn by accident, builds overkill solutions to tiny friction

then there's an evaluation step where the AI scores each post on humor, virality, originality, and cringe â€” and finally synthesizes a "director's cut" that cherry-picks the best parts.
...
- user input â†’ 5 parallel calls to the LLM (one per persona)
...
i also wanted an excuse to try **next.js 16** with **react 19** â€” the new app router patterns are pretty clean.
...
please don't actually post these to linkedin. i am not your mother â€” but i am asking you nicely.
...
if you want: check out the repo [here](https://github.com/anselmlong/linkedin-shitpost). PRs welcome â€” especially for new personas.
